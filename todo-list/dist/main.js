...
function addRemoveEvent(bin, toDo) {
    bin.addEventListener('click', () => {
        ...
        _home__WEBPACK_IMPORTED_MODULE_0__.toDoManager.removeToDoItem(toDo);
    })
}
