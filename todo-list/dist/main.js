...
tabs.forEach(tab => {
    tab.addEventListener('click', (e) => {
        switch (e.target.innerText) {
            case ("Home"):
                _home__WEBPACK_IMPORTED_MODULE_1__.toDoManager.renderHome(main);
                break
            case ("Project"):
                break
            case ("Notes"):
...
toDoForm.addEventListener('submit', (e) => {
    ...
    const newToDo = new _todo__WEBPACK_IMPORTED_MODULE_0__.toDo(toDoInput.title, parseDate(toDoInput.date), toDoInput.priority);
    const newToDoElement = (0,_todo__WEBPACK_IMPORTED_MODULE_0__.createToDoElement)(newToDo);
    _home__WEBPACK_IMPORTED_MODULE_1__.toDoManager.addToDoItem(newToDoElement);
    _home__WEBPACK_IMPORTED_MODULE_1__.toDoManager.renderToDo(main, newToDoElement);
    toDoForm.reset();
    closeModal(modal);
})
...
function parseDate(date) {
    ...
    console.log(dateArr);
    let parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(dateArr[0], dateArr[1] - '01', dateArr[2]), 'LLLL do');
    return parsedDate;
}
})();
